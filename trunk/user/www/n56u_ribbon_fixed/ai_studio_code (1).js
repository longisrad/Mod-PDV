...
// Đã cập nhật Tab 9 (AdGuard Home) và Tab 10 (SQM)
tabtitle[6] = new Array("", "<#Services_Menu_1#>", "<#Services_Menu_2#>", "<#Services_Menu_3#>", "<#Services_Menu_4#>", "<#Services_Menu_5#>", "<#Services_Menu_6#>", "<#Services_Menu_7#>", "<#Services_Menu_8#>", "<#Services_Menu_9#>", "<#Services_Menu_10#>");
...
//Level 3 Tab title - Đã cập nhật liên kết file tương ứng vào tablink[6]
...
tablink[6] = new Array("", "Advanced_Services_Content.asp", "Advanced_Services_DNSCrypt.asp", "Advanced_Services_DoH.asp", "Advanced_Services_DoT.asp", "Advanced_Services_Zapret.asp", "Advanced_Services_Proxy.asp", "Advanced_Services_Service7.asp", "Advanced_Services_Service8.asp", "Advanced_AdGuardHome_Content.asp", "Advanced_SQM_Content.asp");
...
function show_menu(L1, L2, L3){
	...
	if(sw_mode == '3'){
		...
		tabtitle[6][5] = "";
		tabtitle[6][6] = "";
		tabtitle[6][9] = "";  // Ẩn AdGuard Home ở chế độ AP
		tabtitle[6][10] = ""; // Ẩn SQM ở chế độ AP
	}else{
		if(sw_mode == '4'){
